...
<div id="main__form-post">
    <form action="/Board/post/update_process.php?id=<?=$id?>" method="POST">
        <input type="text" name="title" value="<?=$title?>" class="uk-input uk-article-title" placeholder="Type a post title">
        <hr>
